 ...
 *
 * @phpstan-type ChannelUpdateResponseShape = array{
 *   channel: ContactChannel|ContactChannelShape
 * }
 */
final class ChannelUpdateResponse implements BaseModel
{
    /** @use SdkModel<ChannelUpdateResponseShape> */
    use SdkModel;
    ...
    /**
     * `new ChannelUpdateResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ChannelUpdateResponse::with(channel: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ChannelUpdateResponse)->withChannel(...)
     * ```
     */
