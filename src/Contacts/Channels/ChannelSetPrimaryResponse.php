 ...
 *
 * @phpstan-type ChannelSetPrimaryResponseShape = array{
 *   channel: ContactChannel|ContactChannelShape
 * }
 */
final class ChannelSetPrimaryResponse implements BaseModel
{
    /** @use SdkModel<ChannelSetPrimaryResponseShape> */
    use SdkModel;
    ...
    /**
     * `new ChannelSetPrimaryResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ChannelSetPrimaryResponse::with(channel: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ChannelSetPrimaryResponse)->withChannel(...)
     * ```
     */
