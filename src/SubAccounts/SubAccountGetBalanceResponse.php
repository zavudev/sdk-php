...
/**
 * @phpstan-type SubAccountGetBalanceResponseShape = array{
 *   balance: int,
 *   currency: string,
 ...
 * }
 */
final class SubAccountGetBalanceResponse implements BaseModel
{
    /** @use SdkModel<SubAccountGetBalanceResponseShape> */
    use SdkModel;
    ...
    /**
     * `new SubAccountGetBalanceResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SubAccountGetBalanceResponse::with(balance: ..., currency: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SubAccountGetBalanceResponse)->withBalance(...)->withCurrency(...)
     * ```
     */
