...
namespace Zavudev\EmailDomains\EmailDomainListResponse;

use Zavudev\Core\Attributes\Optional;
use Zavudev\Core\Attributes\Required;
use Zavudev\Core\Concerns\SdkModel;
use Zavudev\Core\Contracts\BaseModel;
use Zavudev\EmailDomains\EmailDomainListResponse\Item\DNSRecord;

/**
 * @phpstan-import-type DNSRecordShape from \Zavudev\EmailDomains\EmailDomainListResponse\Item\DNSRecord
 *
...
final class Item implements BaseModel
{
     ...
     * ```
     * Item::with(id: ..., dkimStatus: ..., domain: ..., status: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Item)->withID(...)->withDkimStatus(...)->withDomain(...)->withStatus(...)
     * ```
     */
