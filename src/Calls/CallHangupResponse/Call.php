...
namespace Zavudev\Calls\CallHangupResponse;

use Zavudev\Calls\CallHangupResponse\Call\Direction;
use Zavudev\Calls\CallHangupResponse\Call\Status;
use Zavudev\Calls\CallHangupResponse\Call\Transcript;
...
/**
 * @phpstan-import-type TranscriptShape from \Zavudev\Calls\CallHangupResponse\Call\Transcript
 *
...
final class Call implements BaseModel
{
    ...
    /**
     * `new Call()` is missing required properties by the API.
     *
