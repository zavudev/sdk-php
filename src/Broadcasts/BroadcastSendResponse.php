 ...
 *
 * @phpstan-type BroadcastSendResponseShape = array{
 *   broadcast: Broadcast|BroadcastShape
 * }
 */
final class BroadcastSendResponse implements BaseModel
{
    /** @use SdkModel<BroadcastSendResponseShape> */
    use SdkModel;
    ...
    /**
     * `new BroadcastSendResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BroadcastSendResponse::with(broadcast: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BroadcastSendResponse)->withBroadcast(...)
     * ```
     */
