 ...
 *
 * @phpstan-type BroadcastNewResponseShape = array{
 *   broadcast: Broadcast|BroadcastShape
 * }
 */
final class BroadcastNewResponse implements BaseModel
{
    /** @use SdkModel<BroadcastNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new BroadcastNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BroadcastNewResponse::with(broadcast: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BroadcastNewResponse)->withBroadcast(...)
     * ```
     */
