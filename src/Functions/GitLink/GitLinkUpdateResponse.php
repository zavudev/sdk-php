...
use Zavudev\Functions\GitLink\GitLinkUpdateResponse\Link;

/**
 * @phpstan-import-type LinkShape from \Zavudev\Functions\GitLink\GitLinkUpdateResponse\Link
 *
 * @phpstan-type GitLinkUpdateResponseShape = array{
 *   link: Link|LinkShape, webhookURL: string, webhookSecret?: string|null
 * }
 */
final class GitLinkUpdateResponse implements BaseModel
{
    /** @use SdkModel<GitLinkUpdateResponseShape> */
    use SdkModel;
    ...
    /**
     * `new GitLinkUpdateResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * GitLinkUpdateResponse::with(link: ..., webhookURL: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new GitLinkUpdateResponse)->withLink(...)->withWebhookURL(...)
     * ```
     */
