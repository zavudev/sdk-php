...
use Zavudev\Functions\GitLink\GitLinkLinkResponse\Link;

/**
 * @phpstan-import-type LinkShape from \Zavudev\Functions\GitLink\GitLinkLinkResponse\Link
 *
 * @phpstan-type GitLinkLinkResponseShape = array{
 *   link: Link|LinkShape, webhookURL: string, webhookSecret?: string|null
 * }
 */
final class GitLinkLinkResponse implements BaseModel
{
    /** @use SdkModel<GitLinkLinkResponseShape> */
    use SdkModel;
    ...
    /**
     * `new GitLinkLinkResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * GitLinkLinkResponse::with(link: ..., webhookURL: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new GitLinkLinkResponse)->withLink(...)->withWebhookURL(...)
     * ```
     */
