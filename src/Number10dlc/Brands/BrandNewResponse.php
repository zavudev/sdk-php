 ...
 *
 * @phpstan-type BrandNewResponseShape = array{brand: TenDlcBrand|TenDlcBrandShape}
 */
final class BrandNewResponse implements BaseModel
{
    /** @use SdkModel<BrandNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new BrandNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BrandNewResponse::with(brand: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BrandNewResponse)->withBrand(...)
     * ```
     */
