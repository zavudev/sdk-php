 ...
 *
 * @phpstan-type BrandSyncStatusResponseShape = array{
 *   brand: TenDlcBrand|TenDlcBrandShape
 * }
 */
final class BrandSyncStatusResponse implements BaseModel
{
    /** @use SdkModel<BrandSyncStatusResponseShape> */
    use SdkModel;
    ...
    /**
     * `new BrandSyncStatusResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BrandSyncStatusResponse::with(brand: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BrandSyncStatusResponse)->withBrand(...)
     * ```
     */
