...
final class PhoneNumberUpdateResponse implements BaseModel
{
    ...
    /**
     * `new PhoneNumberUpdateResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PhoneNumberUpdateResponse::with(phoneNumber: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PhoneNumberUpdateResponse)->withPhoneNumber(...)
     * ```
     */
