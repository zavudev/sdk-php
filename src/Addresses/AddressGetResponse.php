 ...
 *
 * @phpstan-type AddressGetResponseShape = array{address: Address|AddressShape}
 */
final class AddressGetResponse implements BaseModel
{
    ...
    /**
     * `new AddressGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AddressGetResponse::with(address: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AddressGetResponse)->withAddress(...)
     * ```
     */
