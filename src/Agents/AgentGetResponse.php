 ...
 *
 * @phpstan-type AgentGetResponseShape = array{agent: Agent|AgentShape}
 */
final class AgentGetResponse implements BaseModel
{
    /** @use SdkModel<AgentGetResponseShape> */
    use SdkModel;
    ...
    /**
     * `new AgentGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AgentGetResponse::with(agent: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AgentGetResponse)->withAgent(...)
     * ```
     */
