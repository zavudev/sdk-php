...
use Zavudev\Agents\AgentUpdateParams\Voice;
 ...
 * Update an agent.
 *
 * @see Zavudev\Services\AgentsService::update()
 *
 * @phpstan-import-type VoiceShape from \Zavudev\Agents\AgentUpdateParams\Voice
 *
