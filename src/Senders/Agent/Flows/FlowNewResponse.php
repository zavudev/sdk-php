 ...
 *
 * @phpstan-type FlowNewResponseShape = array{flow: AgentFlow|AgentFlowShape}
 */
final class FlowNewResponse implements BaseModel
{
    /** @use SdkModel<FlowNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new FlowNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FlowNewResponse::with(flow: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new FlowNewResponse)->withFlow(...)
     * ```
     */
